...
export default function TabbedSlot({
  ...
  return (
    <ScreenContainer enabled={detachInactiveScreens} hasTwoStates style={{ $$css: true }}>
...
>) {
  ...
  return <Link {...props} href={buildLink(name)} onPress={onPress} onLongPress={onLongPress} />;
}
